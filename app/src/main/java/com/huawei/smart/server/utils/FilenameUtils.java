...
public class FilenameUtils {
     ...
     * @return the normalized filename, or null if invalid. Unknown bytes inside string will be removed
     */
     ...
     * @return the normalized filename. Unknown bytes inside string will be removed.
     */
     ...
     * @return the concatenated path, or null if invalid.  Unknown bytes inside string will be removed
     */
     ...
     * @return the prefix of the file, null if invalid. Unknown bytes inside string will be removed
     */
     ...
     * Unknown bytes inside string will be removed
     */
     ...
     * @return the path. Unknown bytes inside string will be removed
     */
    ...
    private static void failIfNullBytePresent(final String path) {
        ...
        for (int i = 0; i < len; i++) {
            if (path.charAt(i) == 0) {
                throw new IllegalArgumentException("Unknown byte present in file/path name. There are no " +
     ...
     *
     * @param filename  the filename to query, null returns null
     * @return the name of the file without the path, or an empty string if none exists. Unknown bytes inside string
     * will be removed
     */
