...
public class BadgeIndicatorView extends AppCompatTextView {
    ...
    public BadgeIndicatorView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        setBackground(9, Color.parseColor("#FE4A67"));
     ...
     * (non-Javadoc)
     *
     * @see android.widget.TextView#setTitleText(java.lang.CharSequence, android.widget.TextView.BufferType)
     */
    @Override
    ...
    public void setTargetView(View target) {
        ...
        if (target.getParent() instanceof FrameLayout) {
            ...
            LOG.error("badge indicator required a parent view to attach");
        }
    }
