...
public class IPAddressUtil {
    ...
    private static boolean isIPv4MappedAddress(byte[] var0) {
        return var0.length >= 16 && (var0[0] == 0 && var0[1] == 0 && var0[2] == 0 && var0[3] == 0 && var0[4] == 0 && var0[5] == 0 && var0[6] == 0 && var0[7] == 0 && var0[8] == 0 && var0[9] == 0 && var0[10] == -1 && var0[11] == -1);
    }
}
